...
public class BoomerangModel<T extends BoomerangEntity> extends EntityModel<BoomerangEntity> {
    public static final ModelLayerLocation BOOMERANG_LAYER = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(MODID, "boomerang"), "main");
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int color) {
        boomerangPart.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
    }
